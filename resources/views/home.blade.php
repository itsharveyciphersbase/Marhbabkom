         ...
         <div class="header-box">
            <div class="header-top">
               <div class="row no-margin">
                  <div class="col l6">
                     <!-- /Logo/ -->
                     <a class="logo" href="http://beta.gulfroots.com">
            ...
            @endif
                  <div class="col l4 user-ctrl">
                     <div class="account-box">
                      ...
                      <!--      <ul>
                              <li><a href="http://beta.gulfroots.com/login">أدراة اﻷعلانات</a></li>
                              <li><a href="http://beta.gulfroots.com/login">الرسائل</a></li>
                              <li><a href="http://beta.gulfroots.com/login">البحث المحفوظة</a></li>
                              <li><a href="http://beta.gulfroots.com/login">الملف الشخصى</a></li>
                           </ul>
                        </div> -->
                     </div>
                     <!-- <div class="add-ad">
