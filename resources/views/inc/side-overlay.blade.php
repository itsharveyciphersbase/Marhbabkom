...
<aside id="side-overlay">
    ...
    <div id="side-overlay-scroll">
        ...
        <div class="side-header side-content">
            ...
            <span>
                <img class="img-avatar img-avatar32" src="{{asset('CustomerBoard')}}/img/avatars/avatar10.jpg" alt="">
                    ...
                    <ul class="nav-users">
                        <li>
                            <a href="base_pages_profile.html">
                                <img class="img-avatar" src="{{asset('CustomerBoard')}}/img/avatars/avatar4.jpg" alt="">
                        ...
                        <li>
                            <a href="base_pages_profile.html">
                                <img class="img-avatar" src="{{asset('CustomerBoard')}}/img/avatars/avatar10.jpg" alt="">
                        ...
                        <li>
                            <a href="base_pages_profile.html">
                                <img class="img-avatar" src="{{asset('CustomerBoard')}}/img/avatars/avatar6.jpg" alt="">
                        ...
                        <li>
                            <a href="base_pages_profile.html">
                                <img class="img-avatar" src="{{asset('CustomerBoard')}}/img/avatars/avatar1.jpg" alt="">
